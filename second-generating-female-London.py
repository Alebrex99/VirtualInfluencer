...
ENHANCEMENT_PROMPT = (
    ...
    "head pose, gaze direction, framing, crop, background (neutral grey, identical to the source), lighting setup, clothing, hairstyle, hair color, hair length "  # CHANGED: added "(neutral grey, identical to the source)"
